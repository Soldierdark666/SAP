...
public class metodos {
    ...
    public void agregarAdelanto(String idAdelanto, String fechaEntrnateAdelanto, String fechaSaleinteAdelanto, String montoAdelanto, String idPrestamoAdelanto) {
        try {
            PreparedStatement pss = cn.prepareStatement("insert into adelanto values(null,?,?,?,?);");
            pss.setString(1, idAdelanto);
            pss.setString(2, fechaEntrnateAdelanto);
            pss.setString(3, fechaSaleinteAdelanto);
            pss.setString(4, montoAdelanto);
            pss.setString(5, idPrestamoAdelanto);
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "error: " + e);
        }
    }

    public void agregarEncargado(String idEncargado, String nombreEncargado, String telefonoEncargado, String direccionEncargado, String idMunicipioEncargado, String idSupervisorEncargado) {
        try {
            PreparedStatement pss = cn.prepareStatement("insert into encargado values(null,?,?,?,?,?);");
            pss.setString(1, idEncargado);
            pss.setString(2, nombreEncargado);
            pss.setString(3, telefonoEncargado);
            pss.setString(4, direccionEncargado);
    ...
    public void agregarFalla (String idFalla, String fechaFalla, String montoFalla, String idPrestamoFalla) {
        try{
            PreparedStatement pss = cn.prepareStatement("insert into falla values(null,?,?,?);");
            pss.setString(1, idFalla);
            pss.setString(2, fechaFalla);
            pss.setString(3, montoFalla);
            pss.setString(4, idPrestamoFalla);
            } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "error: " + e);
        }
    }
    ...
    public void agregarSupervisor(String idSupervisor, String nombreSupervisor, String telefonoSupervisor, String direccionSupervisor, String idMunicipioSupervisor, String idEjecutivoSupervisor){
         try {
    ...
    public void agregarRecuperado(String idRecuperado,String fechaRecuperado,String montoRecuperado,String idPrestamoRecuperado){
        try {
            PreparedStatement pss = cn.prepareStatement("insert into recuperado(null,?,?,?);");
            pss.setString(1, idRecuperado);
            pss.setString(2, fechaRecuperado);
            pss.setString(3, montoRecuperado);  
            pss.setString(4, idPrestamoRecuperado);  
            } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "error: " + e);
         }
    }
    
    public void agregarTrece(String idTrece,String fechaTrece,String montoTrece,String idPrestamoTrece){
         try {
            PreparedStatement pss = cn.prepareStatement("insert into trece(null,?,?,?);");
            pss.setString(1, idTrece);
            pss.setString(2, fechaTrece);
            pss.setString(3, montoTrece);  
            pss.setString(4, idPrestamoTrece);  
            } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "error: " + e);
         }
    }
