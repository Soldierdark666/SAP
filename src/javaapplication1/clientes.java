...
public class clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(buscarEncargado, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 190, -1));
        ...
        jPanel2.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 290, -1, 20));

        statusCliente.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel2.add(statusCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 190, -1));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 340, 80, -1));
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 340, -1, -1));
        ...
        jPanel2.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 380, 290, -1));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, 370, 410));
        ...
        jPanel3.add(especialPrestamo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, -1, -1));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, -1, -1));
        ...
        jPanel3.add(montoPrestamo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, 240, -1));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 0, 350, 410));
        ...
        tblPrestamos.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                tblPrestamosInputMethodTextChanged(evt);
            }
        });
        ...
        jButton5.setText("Editar prestamo");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        jPanel4.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 120, 220, 40));

        jButton6.setText("Eliminar prestamo");
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        jPanel4.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, 220, 40));

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 410, 720, 170));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String txtNombreAval2 = "";
        String txtDireccionAval2 = "";
        String txtMunicipioAval2 = "1";
        String txtEncargado = buscarEncargado.getSelectedItem().toString();
        m1.registrarClientes(txtNombreCliente, txtDireccionCliente, txtMunicipio, txtNombreAval, txtDireccionAval, txtMunicipioAval, txtNombreAval2, txtDireccionAval2, txtMunicipioAval2, "1",txtEncargado);
        vaciarTXT();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if ("Codigo".equals(codigoCliente.getText())) {
            ...
            String txtDireccionAval = direccionAval.getText();
            String txtMunicipioAval = municipioAval.getSelectedItem().toString();
            String txtNombreAval2 = "no";
            String txtDireccionAval2 = "no";
            String txtMunicipioAval2 = "1";
            String txtEncargado=buscarEncargado.getSelectedItem().toString();
            String txtStatusCliente = statusCliente.getSelectedItem().toString();
            m1.editarCliente (txtNombreCliente, txtDireccionCliente, txtMunicipio, txtNombreAval, txtDireccionAval, txtMunicipioAval, txtNombreAval2, txtDireccionAval2, txtMunicipioAval2, txtStatusCliente, txtCodigoCliente, txtEncargado);
            vaciarTXT();
    ...
    private void listClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listClientesMouseClicked
        String Cliente=listClientes.getSelectedValue();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("Codigo".equals(codigoCliente.getText())){
            if (nombreCliente.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Ingrese un cliente para continuar");
            }else{
                ...
                String fechaFin=formato.format(calendar.getTime());
                ...
                String txtEncargado = buscarEncargado.getSelectedItem().toString();
                m1.registrarClientes(txtNombreCliente, txtDireccionCliente, txtMunicipio, txtNombreAval, txtDireccionAval, txtMunicipioAval, txtNombreAval2, txtDireccionAval2, txtMunicipioAval2, "1",txtEncargado);
                String idCliente=m1.returnLastClient();
                m1.agregarPrestamo(fechaInicio, fechaFin, txtMontoPrestamo, especial, idCliente);
                tblPrestamos.setModel(m1.showTabletPrestamo(idCliente));
            }
        }else{
            SimpleDateFormat formato= new SimpleDateFormat("yyyy-MM-dd");
            ...
            m1.agregarPrestamo(fechaInicio, fechaFin, txtMontoPrestamo, especial, txtCodigoCliente);
            tblPrestamos.setModel(m1.showTabletPrestamo(txtCodigoCliente));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (JOptionPane.showConfirmDialog(null, "ESTAS SEGURO??", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            for (int i = 0; i < tblPrestamos.getRowCount(); i++) {
                String idPrestamo=tblPrestamos.getValueAt(i,0).toString();
                String montoPrestamo=tblPrestamos.getValueAt(i,3).toString();
                String especialPrestamo=tblPrestamos.getValueAt(i,4).toString();
                m1.editarPrestamo(especialPrestamo, montoPrestamo, idPrestamo);
            }
        }
    ...
    private void tblPrestamosInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_tblPrestamosInputMethodTextChanged
        
    }//GEN-LAST:event_tblPrestamosInputMethodTextChanged

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        
        if (JOptionPane.showConfirmDialog(null, "ESTAS SEGURO DE ELIMINAR EL PRESTAMO??", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            int row=tblPrestamos.getSelectedRow();
            String idPrestamo = tblPrestamos.getValueAt(row,0).toString();
            m1.borrarPrestamo(idPrestamo);
        }
        
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        filtroCliente f1= new filtroCliente();
        f1.setVisible(true);
